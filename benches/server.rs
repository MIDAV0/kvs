use std::{net::SocketAddr, sync::{Arc, Barrier}, thread};

use criterion::{BenchmarkId, Criterion, criterion_group, criterion_main};
use kvs::{KvClient, KvServer, KvStore, thread_pool::{SharedQueueThreadPool, ThreadPool}};
use tempfile::TempDir;

const NUM_REQUESTS: usize = 100;  // Reduced to stay within OS file descriptor limits
